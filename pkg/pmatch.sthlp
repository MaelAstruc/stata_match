...
Version      : {bf:pmatch} version 0.0.7
...
{p}Astruc--Le Souder, M. (2024). Stata package 'pmatch' version 0.0.7 https://github.com/MaelAstruc/stata_match.{p_end}
