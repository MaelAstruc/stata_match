...
Version      : {bf:pmatch} version 0.0.16
...
{p}Astruc--Le Souder, M. (2025). Stata package 'pmatch' version 0.0.16 https://github.com/MaelAstruc/stata_match.{p_end}
