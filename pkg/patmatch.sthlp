...
Version      : {bf:patmatch} version 1.0.0
Source       : {browse "https://github.com/MaelAstruc/patmatch":GitHub}
...
{p}Please submit bugs, errors, feature requests on {browse "https://github.com/MaelAstruc/patmatch/issues":GitHub} by opening a new issue, or by sending me an email.{p_end}

{title:Citation guidelines}

Suggested citation for this package:

{p}Astruc--Le Souder, M. (2026). Stata package 'patmatch' version 1.0.0 https://github.com/MaelAstruc/patmatch.{p_end}

@software{patmatch,
   author = {Astruc--Le Souder Mael},
   title = {Stata package },
   url = {https://github.com/MaelAstruc/patmatch},
   version = {1.0.0},
   date = {2026-05-26}
}
